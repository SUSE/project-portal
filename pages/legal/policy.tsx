  ...
  return (
    <div>
      ...
      <main className={'relative grid grid-flow-row gap-4 m-[22px] mx-auto max-w-[1400px] w-full p-8'}>
        ...
        <p>The policy covers two main areas;
          1. How we produce open source software. This includes: how we contribute to upstream projects, how we manage the projects where we are ourselves upstream, what legal aspects have to be considered, where code is put, and how to be a good citizen of the open source community.</p>
        ...
        <h3 className='font-medium' id="contributing-to-open-source-projects">Contributing to Open Source Projects</h3>
        ...
        <p>Some projects require a contributor licensing agreement (CLA) which assigns certain rights to the governance body of the project. Before you can contribute to a project which requires a CLA, you need to make sure that SUSE has signed a corporate agreement for the project. SUSE already has agreements in place for many organizations, including Free Software Foundation, OpenStack, Cloud Foundry, Cloud Native Computing Foundation. If the project requires a CLA and is not listed here, contact your manager to establish what needs to be done to make contributions possible. Seek legal assistance if necessary.</p>

        <h4 id="developer-certificate-of-origin">Developer Certificate of Origin</h4>

        <p>Some projects require a <a className="text-blue-500 hover:cursor-pointer" href="https://developercertificate.org/">Developer Certificate of Origin (DCO)</a>. This is typically done by adding a <code>Signed-off-by</code> trailer in the commit message to certify that the committer has the right to do the contribution and to consent to publish it.</p>
        ...
        <p>Follow any codes of conduct and set a high bar for your own behavior. See the <a className="text-blue-500 hover:cursor-pointer" href="https://en.opensuse.org/openSUSE:Guiding_principles">openSUSE Guiding Principles</a> for an example of how we envision the community for one of our main projects.</p>

        <h3 className='font-medium' id="creating-new-projects">Creating new projects</h3>
        ...
        <p>When creating new projects it is good practice to add <code>README.md</code> and <code>CONTRIBUTING.md</code> files explaining the project and how to contribute. Projects must have a declared license.</p>

        <p>When the project is part of a larger open source ecosystem, use the license which is usually used in this ecosystem. Otherwise choose a license compatible with the open source license definition, which matches the goal of the project and its interactions with other projects. This applies to both code and non-code licenses; for example consider the Creative Commons license for documentation, Wiki and other non-code artifacts.</p>
        ...
        <h3 className='font-medium' id="consuming-open-source-software">Consuming Open Source Software</h3>
        ...
        <h3 className='font-medium' id="copyright">Copyright</h3>
        ...
        <h3 className='font-medium' id="licenses">Licenses</h3>
        ...
        <h3 className='font-medium' id="patents">Patents</h3>
        ...
        <h3 className='font-medium' id="foss-liaison">FOSS Liaison</h3>
        ...
        <p className='flex gap-2'>
          Copyright 2021 SUSE LLC. This work is licensed under a <a className="text-blue-500 hover:cursor-pointer" href='https://creativecommons.org/licenses/by-sa/4.0/' target='_blank' rel="noreferrer">Creative Commons Attribution-ShareAlike 4.0 International License.</a>
        </p>
      </main >
    </div >
  )
