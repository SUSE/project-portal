...
export const AllProjects = () => {
  ...
  return (
    <div className='relative mx-auto w-full flex-grow bg-gray-100'>
        ...
        <div className='flex flex-col bg-white mt-28 gap-4 p-8'>
          ...
          <div className='flex flex-col md:flex-row gap-8 mt-6 pb-10'>
            ...
            <div className='flex flex-col gap-10 md:w-10/12'>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>{currentItems && currentItems.map((project) => <ProjectCard key={String(project.name).toLocaleLowerCase()} {...project} />)}</div>
